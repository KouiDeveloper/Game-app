...
@Component({
  selector: 'app-b007-login',
  templateUrl: './b007-login.component.html',
  styleUrls: ['./b007-login.component.css'],
  providers: [WebsocketDataServiceService, ChatService, WebsocketService]
})
export class B007LoginComponent implements OnInit, OnDestroy {
